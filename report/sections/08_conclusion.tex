...
crate PDDL domain (Section~\ref{sec:pddl}); this is validated offline and live
(a \texttt{crates\_one\_way} run now scores~43 with a logged crate push, up from
0), while chained / multi-crate Sokoban planning beyond a single push remains
future work.
