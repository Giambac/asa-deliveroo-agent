...
added and are validated by the offline smoke suite (graph parsing of
type-\texttt{5}/\texttt{5!}, crate-blocked BFS, \texttt{push\_crate} generation
and the \texttt{PushCrate} plan happy/rejected paths); live crate performance on
the course server has not yet been re-measured.
